...
Log in to the host you assigned the host group with the Policy and execute
   ...
   # yum install -y http://yum.theforeman.org/client/3.18/el8/x86_64/foreman-client-release.rpm
...
Click on the column "Reported At" to get a simplified overview. Choose the action "View Full Report" to get the html view generated by OpenSCAP which can be quite slow.
