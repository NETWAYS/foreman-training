...
When PuppetDB is used with Foreman there is normally no interaction between both, they are two completely
different independent report targets. With this plugin a host is also disabled in PuppetDB when it is deleted in
Foreman.
